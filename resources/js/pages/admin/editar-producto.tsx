...
interface Producto {
    ...
    tipo_pago_preventa: string | null;
    porcentaje_anticipo: number | null;
    limite_preventa: number | null;
}
...
export default function EditarProducto({ producto, categorias }: Props) {
    const { data, setData, post, processing, errors, transform } = useForm({
        ...
        fecha_inicio_preventa: producto.fecha_inicio_preventa ? producto.fecha_inicio_preventa.substring(0, 10) : '',
        fecha_fin_preventa: producto.fecha_fin_preventa ? producto.fecha_fin_preventa.substring(0, 10) : '',
        fecha_disponibilidad: producto.fecha_disponibilidad ? producto.fecha_disponibilidad.substring(0, 10) : '',
        tipo_pago_preventa: producto.tipo_pago_preventa || 'completo',
        porcentaje_anticipo: producto.porcentaje_anticipo || '',
        limite_preventa: producto.limite_preventa || '',
