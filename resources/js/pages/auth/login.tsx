...
export default function Login({ status, canResetPassword }: Props) {
    const [loginType, setLoginType] = useState<'cliente' | 'admin'>('admin');
                        ...
                        <>
                            <div className="grid gap-6">
                                ...
                                <div className="grid gap-2">
                                    <div className="flex items-center justify-between mb-1">
                                        ...
                                        {canResetPassword && (
                                            <TextLink
                                                href={request()}
                                                className="text-[#ff5500] hover:text-[#ff7733] text-[10px] font-bold tracking-widest uppercase"
                                                tabIndex={5}
                                            >
                                    ...
                                    <div className="relative">
                                        ...
                                        />
                                        <Eye className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#888888] cursor-pointer hover:text-white transition-colors" />
                                    </div>
                                ...
                                <div className="flex items-center space-x-3 mt-1">
                                    ...
                                    />
                                    <Label htmlFor="remember" className="text-[#888888] text-[13px] font-normal cursor-pointer">
                            ...
                            {/* Google Button */}
                            <Button type="button" variant="outline" className="w-full bg-[#111111] border-[#333333] hover:bg-[#222222] hover:text-white text-white h-[52px] font-bold text-[11px] tracking-widest uppercase rounded-none">
                            ...
                            <div className="text-center text-xs text-[#888888] mt-2 font-medium">
                                ...
                                <TextLink href={register()} tabIndex={5} className="text-[#ff5500] hover:text-[#ff7733] underline underline-offset-4 decoration-[#ff5500]/40 hover:decoration-[#ff7733]">
                                    Regístrate ahora
                                </TextLink>
                            </div>
                        </>
